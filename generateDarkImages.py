...
"""Generate low-light pair images from Tiktok dataset for visulization"""
# image_path = "/mnt/disk1/data/tiktokdataset/0007/images/0001.png"
# image_path2 = "/mnt/disk1/data/tiktokdataset/0007/images/0060.png"
...
# img.save("/mnt/disk1/data/relight/pair.jpg")
# # img = Image.open(image_path)
# # img.show()
# degrade_result = Dark_ISP("/mnt/disk1/data/relight/pair.jpg").__call__()
# # degrade_result = np.clip(degrade_result, 0.0,1.0)
# degrade_result = (degrade_result * 255).astype(np.uint8)
# # to_pil = transforms.ToPILImage()
# # degrade_result_pil = to_pil(degrade_result)
# degrade_result_pil = Image.fromarray(degrade_result)
# # degrade_result_pil.show()
# degrade_result_pil.save(os.path.join("/mnt/disk1/data/relight", "pair_1"))

'''Generate low-light images for the Market-1501 dataset'''
num_lowlight_per_image = 3
output_path = "/mnt/disk1/data/Market1501_LowLight/Market-1501-v15.09.15"
dataset_path = "/mnt/disk1/data/Market1501/Market-1501-v15.09.15"
